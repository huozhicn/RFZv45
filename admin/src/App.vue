...
async function sendMessage() {
  ...
  try {
    ...
    console.error('[App] sendMessage failed:', err.message)
  } finally {
    sending.value = false
  }
}
      ...
      <n-layout v-else style="height: 100vh" has-sider>
        ...
        <n-layout>
          <n-layout-content style="padding-bottom:72px">
            <n-scrollbar ref="chatScrollEl" style="max-height:calc(100vh - 72px)">
              <div style="padding:16px 24px">
                ...
                <div v-if="!currentTable && chatMessages.length === 0" style="text-align:center;padding:80px 0;color:#999">
                  ...
                  <div style="font-size:14px">👈 选择左侧表 或 💬 在下方对话中输入指令</div>
